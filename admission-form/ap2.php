...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $defence_ward = $_POST['defence_ward'] ?? 'No';
...
<div class="form-row">
  ...
  <div id="otherCourseBox"
    ...
    <input type="text"
           name="other_course_details"
           placeholder="If yes, specify course / college">
  ...
  <!-- Q10 -->
  <div class="form-row">
  <label>25. Ward of Defence Personnel / Ex-Servicemen 
  <span class="required-star">*</span></label>

  <div class="inline">

    <label class="radio-item">
      <input type="radio" name="defence_ward" value="Defence Service" required>
      Ward of Defence Service Personnel
    </label>

    <label class="radio-item">
      <input type="radio" name="defence_ward" value="Ex-Servicemen">
      Ward of Ex-Servicemen (Navy / Army / Air Force)
    </label>

    <label class="radio-item">
      <input type="radio" name="defence_ward" value="No">
      Not Applicable
    </label>
...
<fieldset>
  ...
  <div class="form-row">
    ...
    <div class="radio-group">
      ...
      <label class="radio-item">
        <input type="radio" name="abc" value="Yes">
        Yes
      </label>

      <label class="radio-item">
        <input type="radio" name="abc" value="No">
        No
      </label>
  ...
  <div class="form-row">
    <div class="inline">
      <label>
       ...
       name="enclosures[]"
       value="HSC" disabled>
        HSC Statement of Marks / Diploma Statement of Marks
      </label>
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="inline">
      <label>
       ...
       name="enclosures[]"
       value="UG" disabled>
        UG Statement of Marks / Provisional / Degree
      </label>
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="inline">
      <label>
       ...
       id="enc_tc"
       name="enclosures[]"
       value="Transfer Certificate" disabled>
        Transfer Certificate / Course Completion Certificate
      </label>
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="inline">
      <label>
       ...
       id="enc_migration"
       name="enclosures[]"
       value="Migration" disabled>
        Migration Certificate (Other State Students only)
      </label>
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="inline">
      <label>
       ...
       id="enc_undertaking"
       name="enclosures[]"
       value="Undertaking" disabled>
        Undertaking (if any – Certificates due)
      </label>
    </div>
  </div>
  ...
  <div class="sign">
    <label><strong>Signature of the Applicant</strong></label>
      ...
      <div class="actions">
        ...
        <button type="submit" name="back" value="1" class="btn btn-outline">
          BACK
        </button>
